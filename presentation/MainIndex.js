...
const images = {
  background: require("../assets/imgs/coding.jpg"),
};
			...
			<Spectacle theme={theme}>
		        <Deck transition={["zoom", "slide"]} transitionDuration={500} progress={'none'}>
		          	<Slide transition={["zoom"]} bgColor="primary" bgImage={images.background.replace("/", "")} bgDarken={0.45}>
		            	...
		            	<p><RouteLink style={{color: '#fff'}} to="dia-2">Arquitetura e Front-end</RouteLink></p>
		            	<p><RouteLink style={{color: '#fff'}} to="dia-3">Back-end e distribuição</RouteLink></p>
